...
/** A base class for arithmetic unary operators +, - */
class ArithmeticUnaryOperator : public UnaryOperator {
protected:
    /**
     ...
     */
    ArithmeticUnaryOperator(ExpressionType type, ExpressionPtr&& operand) noexcept
...
public:
    ...
    /**
     * Checks if operand is numeric and valid.
     * @param context Evaluation context.
     * @std::runtime_error if operand isn't numeric or not valid
     */
