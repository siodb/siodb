...
class UserAccessKeyRegistry {
public:
    /** Registry record type */
    using value_type = UserAccessKeyRecord;
            ...
            boost::multi_index::indexed_by<
                    ...
                    boost::multi_index::hashed_unique<boost::multi_index::tag<ByNameTag>,
                            boost::multi_index::member<value_type, decltype(value_type::m_name),
                                    &value_type::m_name>>,
                    boost::multi_index::hashed_non_unique<boost::multi_index::tag<ByStateTag>,
                            boost::multi_index::member<value_type, decltype(value_type::m_active),
                                    &value_type::m_active>>>>
            Container;
...
public:
     ...
     */
    bool operator==(const UserAccessKeyRegistry& other) const noexcept
    {
    ...
    /**
     * Returns read-only index by key state.
     * @return Registry index object.
     */
    const auto& byState() const noexcept
    {
        return m_container.get<ByStateTag>();
    }
     ...
     */
    void swap(UserAccessKeyRegistry& other) noexcept
    {
