...
class Int32UniqueLinearIndex : public UniqueLinearIndex {
public:
    /**
     ...
     */
    Int32UniqueLinearIndex(Table& table, const std::string& name, std::size_t valueSize,
     ...
     * @param valueSize Value size.
     */
    Int32UniqueLinearIndex(Table& table, const IndexRecord& indexRecord, std::size_t valueSize);
};
