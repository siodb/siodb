...
class UInt64UniqueLinearIndex : public UniqueLinearIndex {
public:
    /**
     ...
     */
    UInt64UniqueLinearIndex(Table& table, const std::string& name, std::size_t valueSize,
     ...
     * @param valueSize Value size.
     */
    UInt64UniqueLinearIndex(Table& table, const IndexRecord& indexRecord, std::size_t valueSize);
};
