...
class Int16UniqueLinearIndex : public UniqueLinearIndex {
public:
    /**
     ...
     */
    Int16UniqueLinearIndex(Table& table, const std::string& name, std::size_t valueSize,
     ...
     * @param valueSize Value size.
     */
    Int16UniqueLinearIndex(Table& table, const IndexRecord& indexRecord, std::size_t valueSize);
};
