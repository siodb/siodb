...
class UInt16UniqueLinearIndex : public UniqueLinearIndex {
public:
    /**
     ...
     */
    UInt16UniqueLinearIndex(Table& table, const std::string& name, std::size_t valueSize,
     ...
     * @param valueSize Value size.
     */
    UInt16UniqueLinearIndex(Table& table, const IndexRecord& indexRecord, std::size_t valueSize);
};
