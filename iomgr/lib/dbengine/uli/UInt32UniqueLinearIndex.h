...
class UInt32UniqueLinearIndex : public UniqueLinearIndex {
public:
    /**
     ...
     */
    UInt32UniqueLinearIndex(Table& table, const std::string& name, std::size_t valueSize,
     ...
     * @param valueSize Value size.
     */
    UInt32UniqueLinearIndex(Table& table, const IndexRecord& indexRecord, std::size_t valueSize);
};
