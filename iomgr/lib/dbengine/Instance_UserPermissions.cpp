...
const std::unordered_map<DatabaseObjectType, std::uint64_t> Instance::s_allowedPermissions {
        ...
        {DatabaseObjectType::kColumn, buildMultiPermissionMask<PermissionType::kCreate,
                                              PermissionType::kDrop, PermissionType::kAlter>()},
        {DatabaseObjectType::kIndex, buildMultiPermissionMask<PermissionType::kCreate,
                                             PermissionType::kDrop, PermissionType::kAlter>()},
        {DatabaseObjectType::kConstraint, buildMultiPermissionMask<PermissionType::kCreate,
                                                  PermissionType::kDrop, PermissionType::kAlter>()},
        {DatabaseObjectType::kTrigger, buildMultiPermissionMask<PermissionType::kCreate,
                                               PermissionType::kDrop, PermissionType::kAlter>()},
        {DatabaseObjectType::kProcedure, buildMultiPermissionMask<PermissionType::kCreate,
                                                 PermissionType::kDrop, PermissionType::kAlter>()},
        {DatabaseObjectType::kFunction, buildMultiPermissionMask<PermissionType::kCreate,
                                                PermissionType::kDrop, PermissionType::kAlter>()},
        {DatabaseObjectType::kUser,
                buildMultiPermissionMask<PermissionType::kCreate, PermissionType::kDrop,
                        PermissionType::kAlter, PermissionType::kShowPermissions>()},
        {DatabaseObjectType::kUserAccessKey,
                buildMultiPermissionMask<PermissionType::kCreate, PermissionType::kDrop,
                        PermissionType::kAlter>()},
        {DatabaseObjectType::kUserToken, buildMultiPermissionMask<PermissionType::kCreate,
                                                 PermissionType::kDrop, PermissionType::kAlter>()},
};
