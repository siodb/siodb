...
func (rs *RestServerConfig) parseConfiguration(SiodbInstanceConfigurationPath string, config Config) (err error) {
...
func parseConfig(object string, filename string) (Config, error) {
