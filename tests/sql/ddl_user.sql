...
create user nicolas;
create user buzz with state = inactive;
select * from sys_users;

alter user nicolas set description = 'I am Nicolas';
alter user buzz set real_name= 'Buzzzzzz', description = 'I am Buzzzzzz';
select * from sys_users;
...
alter user nicolas alter access key mykey set description = 'my key';
select * from sys_user_access_keys;

alter user nicolas alter access key mykey set description = null;
select * from sys_user_access_keys;
...
alter user nicolas alter token mytoken2 set expiration_timestamp='2022-01-01 01:01:01';
select * from sys_user_tokens;

alter user nicolas alter token mytoken1 set description='my token #1';
alter user nicolas alter token mytoken2 set description='my token #2';
select * from sys_user_tokens;

alter user nicolas alter token mytoken2 set description=null;
select * from sys_user_tokens;

alter user nicolas alter token mytoken1 set expiration_timestamp=null;
select * from sys_user_tokens;
