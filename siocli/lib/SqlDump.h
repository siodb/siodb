 ...
 * @param printDebugMessages Turns on printing debug messages to stderr.
 * @throw std::runtime_error if I/O error occurs.
 */
void dumpAllDatabases(
        siodb::io::InputOutputStream& connection, std::ostream& os, bool printDebugMessages);
